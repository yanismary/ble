...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__conversion__ = __webpack_require__(108);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__timeout__ = __webpack_require__(678);



class BluetoothLeWeb extends __WEBPACK_IMPORTED_MODULE_0__capacitor_core__["b" /* WebPlugin */] {
    constructor() {
        super(...arguments);
    ...
    onAdvertisementReceived(event) {
        ...
        if (isNew || ((_a = this.requestBleDeviceOptions) === null || _a === void 0 ? void 0 : _a.allowDuplicates)) {
            ...
            const result = {
                ...
                manufacturerData: Object(__WEBPACK_IMPORTED_MODULE_1__conversion__["e" /* mapToObject */])(event.manufacturerData),
                serviceData: Object(__WEBPACK_IMPORTED_MODULE_1__conversion__["e" /* mapToObject */])(event.serviceData),
                uuids: (_b = event.uuids) === null || _b === void 0 ? void 0 : _b.map(__WEBPACK_IMPORTED_MODULE_1__conversion__["i" /* webUUIDToString */]),
            };
    ...
    async connect(options) {
        ...
        try {
            ...
            await Object(__WEBPACK_IMPORTED_MODULE_2__timeout__["a" /* runWithTimeout */])(device.gatt.connect(), timeout, timeoutError);
        }
        catch (error) {
    ...
    async write(options) {
        ...
        if (typeof options.value === 'string') {
            dataView = Object(__WEBPACK_IMPORTED_MODULE_1__conversion__["d" /* hexStringToDataView */])(options.value);
        }
        else {
...
/* harmony export (immutable) */ __webpack_exports__["BluetoothLeWeb"] = BluetoothLeWeb;
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = runWithTimeout;
